...
#SBATCH --job-name=cr3-nemotron-tp00303-lr15e5-lr1e6-dmcq2p2n-ds1-tp302en
...
export CR3_ENERGON_PATH='/lustre/fs11/portfolios/edgeai/projects/edgeai_tao-ptm_image-foundation-model-clip/users/chrislin/datasets/cr3-nemotron/energon/tp00303/tp00303_lr15e5_lr1e6_dmcq2p2n_ds1_tp302en'
export CR3_CKPT_SAVE='/lustre/fs11/portfolios/edgeai/projects/edgeai_tao-ptm_image-foundation-model-clip/users/chrislin/cr3-nemotron/ckpt/tp00303/tp00303_lr15e5_lr1e6_dmcq2p2n_ds1_tp302en'
...
echo 'Starting omni3 SFT for run: tp00303_lr15e5_lr1e6_dmcq2p2n_ds1_tp302en'
torchrun --nproc-per-node=8 train.py \
    --config /workspace/Nemotron/src/nemotron/recipes/omni3/stage0_sft/config/cr3/tp00303/tp00303_lr15e5_lr1e6_dmcq2p2n_ds1_tp302en.yaml
"
