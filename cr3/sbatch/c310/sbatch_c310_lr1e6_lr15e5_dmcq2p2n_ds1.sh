...
#SBATCH --job-name=cr3-nemotron-c310-lr1e6-lr15e5-dmcq2p2n-ds1
...
export CR3_ENERGON_PATH='/lustre/fs11/portfolios/edgeai/projects/edgeai_tao-ptm_image-foundation-model-clip/users/chrislin/datasets/cr3-nemotron/energon/c310/c310_lr1e6_lr15e5_dmcq2p2n_ds1'
export CR3_CKPT_SAVE='/lustre/fs11/portfolios/edgeai/projects/edgeai_tao-ptm_image-foundation-model-clip/users/chrislin/cr3-nemotron/ckpt/c310/c310_lr1e6_lr15e5_dmcq2p2n_ds1'
...
echo 'Starting omni3 SFT for run: c310_lr1e6_lr15e5_dmcq2p2n_ds1'
torchrun --nproc-per-node=8 train.py \
    --config /workspace/Nemotron/src/nemotron/recipes/omni3/stage0_sft/config/cr3/c310/c310_lr1e6_lr15e5_dmcq2p2n_ds1.yaml
"
