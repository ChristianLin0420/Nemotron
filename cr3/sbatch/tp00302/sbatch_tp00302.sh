...
#SBATCH --job-name=cr3-nemotron-tp00302
...
export CR3_ENERGON_PATH='/lustre/fs11/portfolios/edgeai/projects/edgeai_tao-ptm_image-foundation-model-clip/users/chrislin/datasets/cr3-nemotron/energon/tp00302/tp00302'
export CR3_CKPT_SAVE='/lustre/fs11/portfolios/edgeai/projects/edgeai_tao-ptm_image-foundation-model-clip/users/chrislin/cr3-nemotron/ckpt/tp00302/tp00302'
...
echo 'Starting omni3 SFT for run: tp00302'
torchrun --nproc-per-node=8 train.py \
    --config /workspace/Nemotron/src/nemotron/recipes/omni3/stage0_sft/config/cr3/tp00302/tp00302.yaml
"
