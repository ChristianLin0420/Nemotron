...
#SBATCH --job-name=cr3-nemotron-assy17-lr15e5-lr1e6-dmcq1p2n-ds1-assy07en
...
export CR3_ENERGON_PATH='/lustre/fs11/portfolios/edgeai/projects/edgeai_tao-ptm_image-foundation-model-clip/users/chrislin/datasets/cr3-nemotron/energon/assy17/assy17_lr15e5_lr1e6_dmcq1p2n_ds1_assy07en'
export CR3_CKPT_SAVE='/lustre/fs11/portfolios/edgeai/projects/edgeai_tao-ptm_image-foundation-model-clip/users/chrislin/cr3-nemotron/ckpt/assy17/assy17_lr15e5_lr1e6_dmcq1p2n_ds1_assy07en'
...
echo 'Starting omni3 SFT for run: assy17_lr15e5_lr1e6_dmcq1p2n_ds1_assy07en'
torchrun --nproc-per-node=8 train.py \
    --config /workspace/Nemotron/src/nemotron/recipes/omni3/stage0_sft/config/cr3/assy17/assy17_lr15e5_lr1e6_dmcq1p2n_ds1_assy07en.yaml
"
